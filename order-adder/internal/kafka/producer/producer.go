...
type Producer interface {
	SendMessageForSetStatusOrder(topic string, order models.StatusOrder) error
}
...
func (p *ProducerManager) SendMessageForSetStatusOrder(topic string, order models.StatusOrder) error {
